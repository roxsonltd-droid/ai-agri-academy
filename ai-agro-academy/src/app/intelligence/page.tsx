...
import { ChevronLeft, CloudRain, ShieldAlert, CircleDollarSign, Tractor, LineChart, Cpu, Sun, ThermometerSnowflake, Droplets, ArrowUpRight } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 border-b border-slate-800 pb-6 shrink-0">
          <div>
            ...
            <div className="flex items-center space-x-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-white tracking-tight">Agri Intelligence Center</h1>
            </div>
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-5 mb-6">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="text-slate-300 text-sm">Пазарната цена на слънчогледа се покачи с 5%. Препоръчително е да продадете 30% от наличностите днес.</p>
                  </li>
                  <li className="flex items-start">
