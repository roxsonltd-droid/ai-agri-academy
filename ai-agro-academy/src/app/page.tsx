...
export default function Home() {
  ...
  const features = [
    ...
    { title: "Автономни Агенти", desc: "Агенти, които мислят, планират и управляват вашите ресурси автономно.", icon: Bot, color: "from-purple-400 to-purple-500", bg: "bg-purple-500/10", href: "/faculty/agromind" },
    { title: "Симулации", desc: "Тествайте стратегии за засаждане и торене във виртуална среда.", icon: Code2, color: "from-blue-400 to-blue-500", bg: "bg-blue-500/10", href: "/labs" },
    ...
    { title: "Видео Уроци", desc: "Генериране на 3D видео симулации за работа с агро техника.", icon: Video, color: "from-red-400 to-red-500", bg: "bg-red-500/10", href: "/courses" },
    ...
    { title: "Добив и Данни", desc: "Качвайте таблици и получавайте моментални AI прогнози за добива.", icon: BarChart3, color: "from-emerald-400 to-emerald-500", bg: "bg-emerald-500/10", href: "/data" },
    { title: "Мултиезичност", desc: "Превеждайте земеделска литература от над 100 езика моментално.", icon: Languages, color: "from-indigo-400 to-indigo-500", bg: "bg-indigo-500/10", href: "/translate" },
    { title: "Смарт Напояване", desc: "Интеграция с IoT сензори за автоматично контролиране на водата.", icon: Zap, color: "from-yellow-400 to-yellow-500", bg: "bg-yellow-500/10", href: "/irrigation" },
    { title: "Глобални Пазари", desc: "Следете борсовите цени на зърното и торовете в реално време.", icon: Globe, color: "from-sky-400 to-sky-500", bg: "bg-sky-500/10", href: "/markets" },
      ...
      <section className="relative w-full pt-40 pb-20 md:pt-48 md:pb-28 overflow-hidden flex flex-col items-center text-center">
        ...
        <div className="container px-6 lg:px-8 mx-auto z-10 flex flex-col items-center">
          ...
          >
            ...
            {/* Massive Heading */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.1] max-w-4xl">
        ...
        <div className="container px-4 md:px-8 mx-auto">
          ...
          >
            {features.map((feature, idx) => {
              const CardContent = (
                <div className="relative h-full bg-white/5 border border-white/10 p-5 md:p-6 rounded-xl md:rounded-2xl overflow-hidden group hover:border-white/20 transition-all duration-500">
                  <div className="relative z-10 flex flex-col h-full">
                    <div className={`w-10 h-10 md:w-12 md:h-12 rounded-xl ${feature.bg} flex items-center justify-center mb-4 md:mb-5 border border-white/5 group-hover:scale-110 transition-transform duration-500 ease-out`}>
